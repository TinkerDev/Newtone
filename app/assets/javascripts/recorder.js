var Recorder = {
    ...
    _setupFlashContainer: function(){
        ...
        this.options.flashContainer.setAttribute("style", "position: absolute; left: -9999px; top: -9999px; width: 284px; height: 160px; margin-left: 10px; border-top: 6px solid rgba(128, 128, 128, 0.6); border-bottom: 6px solid rgba(128, 128, 128, 0.6); border-radius: 5px 5px; padding-bottom: 1px; padding-right: 1px;");
    ...
    _loadFlash: function(){
        ...
        swfobject.embedSWF(this.options.swfSrc, "recorderFlashObject", "285", "151", "10.1.0", undefined, undefined, {allowscriptaccess: "always"}, undefined, function(e){
            if(e.success){
